...
function ProjectDetails() {
  ...
  const details = {
    ...
    'Venpani Malare': {
       releaseDate: 'Episode 1: 8th dec 2021',
       ...
       watchLink: 'http://www.youtube.com/watch?v=-rZWOW8UfIk', // Updated to the correct episode 1 link
    },
            ...
            {projectDetails && (
              <>
                ...
                <p className="text-gray-600 mb-2">
                 ...
                 {project.title === 'Venpani Malare' && project.episodes && project.episodes.length > 0 ? (
                    <div>
                      <h4 className="text-xl font-semibold text-gray-800 mt-4 mb-2">Episodes</h4>
                      <ul>
                        {project.episodes.map(episode => (
                          <li key={episode.title} className="mb-2">
